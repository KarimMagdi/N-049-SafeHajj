...
public class MainActivity extends WearableActivity implements CapabilityClient.OnCapabilityChangedListener {
    ...
    private static final String ANDROID_MARKET_APP_URI = "https://play.google.com/store?hl=en";

    private TextView mTextView;
    private Node mAndroidNodeWithApp = null;
    private TextView zoneIndicatorMessageTextView;
    private ImageView installAppButton;
    private TextView installAppMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zoneIndicatorMessageTextView = findViewById(R.id.zoneIndicatorMessageTextView);
        installAppButton = findViewById(R.id.installAppButton);
        installAppMessage = findViewById(R.id.installAppMessage);
        ...
        capabilityInfoTask.addOnCompleteListener(new OnCompleteListener<CapabilityInfo>() {
            ...
            public void onComplete(Task<CapabilityInfo> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    mAndroidNodeWithApp = pickBestNodeId(capabilityInfo.getNodes());
    ...
    private void verifyNodeAndUpdateUI() {
        ...
        if (mAndroidNodeWithApp != null) {

            // TODO: Add your code to communicate with the phone app via
            // Wear APIs (MessageApi, DataApi, etc.)

            String installMessage =
                    String.format(INSTALLED_MESSAGE, mAndroidNodeWithApp.getDisplayName());
            Log.d(TAG, installMessage);

            zoneIndicatorMessageTextView.setVisibility(View.VISIBLE);
            installAppButton.setVisibility(View.GONE);
            installAppMessage.setVisibility(View.GONE);

        } else {

            zoneIndicatorMessageTextView.setVisibility(View.GONE);
            installAppButton.setVisibility(View.VISIBLE);
            installAppMessage.setVisibility(View.VISIBLE);

            Log.d(TAG, MISSING_MESSAGE);

            installAppButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ...
                    if (mAndroidNodeWithApp != null) {
                        ...
                        installAppMessage.setText(getString(R.string.connect_with_mobile));
                    }
                }
            });
